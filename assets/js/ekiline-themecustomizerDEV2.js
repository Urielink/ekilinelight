	...
	$.each( colors, function( key, value ) {
		...
		wp.customize( value, 'ekiline_textarea_css', function( field1, field2 ) {
			...
			field1.bind( function( value ) {
				...
				//footer
				var bgFtColor = wp.customize.value('footer_color')();
				var txFtColor = wp.customize.value('ftext_color')();
				var aFtColor = wp.customize.value('flinks_color')();
				//footer-bar
				var FbColor = wp.customize.value('fbar_color')();
				var txFbColor = wp.customize.value('fbartxt_color')();
				var aFbColor = wp.customize.value('fbarlks_color')();
				//bootstrap
				...
				function cssOrders(jsoncolors) {
					...
					// navbar	
						...
						if ( $mainColor !== '#f9fafbFF' ){
							cssall += '#primary{background-color:' + $mainColor + ' !important;}';
						}
