...
jQuery(document).ready(function($){
		 ...
		 //pagina		
			var bgColor = themeColors2.fondo;
			var txColor = themeColors2.texto;
			var mainColor = themeColors2.main;
		//navbar
			var bgNvColor = themeColors2.menu;
		//footer
			var bgFtColor = themeColors2.footer;
			var txFtColor = themeColors2.ftxt;
			var aFtColor = themeColors2.flinks;
		//footer-bar
			var FbColor = themeColors2.fbar;
			var txFbColor = themeColors2.fbartxt;
			var aFbColor = themeColors2.fbarlks;
		//bootstrap
			var colPri = themeColors2.b4primary;
			var colSec = themeColors2.b4secondary;
			var colSuc = themeColors2.b4success;
			var colDan = themeColors2.b4danger;
			var colWar = themeColors2.b4warning;
			var colInf = themeColors2.b4info;
			var colLig = themeColors2.b4light;
			var colDak = themeColors2.b4dark;
...
// este es el metodo para llamar colores con el api de customizr.
// https://make.wordpress.org/core/2016/03/22/implementing-selective-refresh-support-for-widgets/

// 1 solo valor
			// ( function( $, api ) {

			// 	api( 'back_color', function( setting ) {
...
// otro metodo JQ
			...
			// 	wp.customize( 'back_color', function( value ) {
			...
			(function( $ ) {
				...
				$.each( colors, function( key, value ) {
					...
					wp.customize( value, function( set ) {

						set.bind( function( value ) {
	
							//console.log( key + value );
							// var bgColor = '';
							// var txColor = ''; // no funciona declarar cada variable, borra el historial.

							// por cada color se levanta un indice.
							if (key==0){
								bgColor = value;
...
/* funcion de practica **/
/* ------------------------------------------ */
// function xrgbaToHexOp(xrgba) {
// 	wp.customize( xrgba, function( value ) {
// 		value.bind( function( to ) {
// 			console.log(to);			
// 		} );
// 	});
// }
// xrgbaToHexOp('back_color')
// xrgbaToHexOp('text_color')
